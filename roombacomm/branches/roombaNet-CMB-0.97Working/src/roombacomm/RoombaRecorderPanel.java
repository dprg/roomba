...
//            roombacomm.setLEDs(true,true,true, true,true,true, 255, 255);
        	roombacomm.setToggleCheckRobot(true);
        	roombacomm.setToggleClean(true);
        	roombacomm.setToggleDirt(true);
        	roombacomm.setToggleDirt(true);
        	roombacomm.setGreenOn(true);
        	roombacomm.setToggleMax(true);
        	roombacomm.setPower_color(255);
        	roombacomm.setPower_int(255);
        	roombacomm.setRedOn(true);
        	roombacomm.setToggleSpot(true);
        	roombacomm.setLEDs(roombacomm);
        	
            roombacomm.pause(300);
//            roombacomm.setLEDs(false,false,false, false,false,false, 0, 128);
            roombacomm.setToggleCheckRobot(false);
        	roombacomm.setToggleClean(false);
        	roombacomm.setToggleDirt(false);
        	roombacomm.setToggleDirt(false);
        	roombacomm.setGreenOn(false);
        	roombacomm.setToggleMax(false);
        	roombacomm.setPower_color(0);
        	roombacomm.setPower_int(128);
        	roombacomm.setRedOn(false);
        	roombacomm.setToggleSpot(false);
        	roombacomm.setLEDs(roombacomm);
        }        
